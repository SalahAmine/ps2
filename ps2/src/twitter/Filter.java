...
public class Filter {
    ...
    public static List<Tweet> writtenBy(List<Tweet> tweets, String username) {
        ...
        assert Extract.EnsureTweetIdsAreDifferent(tweets);
    ...
    public static List<Tweet> containing(List<Tweet> tweets, List<String> words) {
        ...
        assert Extract.EnsureTweetIdsAreDifferent(tweets);
        assert EnsureWordsListisValid(words);
        ...
        for (Tweet tweet : tweets) {
            ...
            if (tweet.getText().contains(word.toLowerCase())) {
                ts.add(tweet);
                break;
            }
        }
    ...
    public static boolean EnsureWordsListisValid(List<String> words) {
