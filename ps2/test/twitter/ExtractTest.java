...
public class ExtractTest {
     ...
     * Partitions 
     * getTimespan :
     * number of tweet ids = 2,  >2 odd , and >3 even 
     * tweets.timestamps have equal values, different values  
     * 
    ...
    private static final Tweet tweet4 = new Tweet(4, "alyssa", "is it reasonable to talk about rivest so much?", d4);
